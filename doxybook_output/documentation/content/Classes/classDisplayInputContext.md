---
title: DisplayInputContext
summary: Input context class for display input.  

---

**DisplayInputContext Class Reference**
...
|                | Name           |
| -------------- | -------------- |
| | **[DisplayInputContext](classes/classdisplayinputcontext/#function-displayinputcontext)**([AppParameters](classes/structappparameters/) parameters, std::vector< [LEDContext](classes/classledcontext/) > && led_vector, bool active) |
| virtual std::tuple< [AppParameters](classes/structappparameters/) &, std::vector< [LEDContext](classes/classledcontext/) > & > | **[Process](classes/classdisplayinputcontext/#function-process)**() |
...
### function DisplayInputContext

```cpp
inline DisplayInputContext(
