---
title: UserManualInputContext
summary: Input context class for manual user input.  

---

**UserManualInputContext Class Reference**
...
|                | Name           |
| -------------- | -------------- |
| | **[UserManualInputContext](classes/classusermanualinputcontext/#function-usermanualinputcontext)**([AppParameters](classes/structappparameters/) parameters, [UserManualData](classes/structusermanualdata/) userManualData, bool active) |
| virtual std::tuple< [AppParameters](classes/structappparameters/) &, std::vector< [LEDContext](classes/classledcontext/) > & > | **[Process](classes/classusermanualinputcontext/#function-process)**() |
...
### function UserManualInputContext

```cpp
inline UserManualInputContext(
